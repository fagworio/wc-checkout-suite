...
| Prova | Resultado |
|---|---|
| `tests/browser/fase16-usability.mjs` | **20/0**, com três asserções novas: escolher um destino escreve `area=` no endereço **sem perder** `section=fields`; o destino mostra o nome e o caminho em linhas próprias e veste o sistema de desenho (`border: solid`, superfície branca, sem decoração de texto) em vez do botão do browser; e o endereço, seguido por outra pessoa, reabre o mesmo destino com «Pedido» selecionado |
