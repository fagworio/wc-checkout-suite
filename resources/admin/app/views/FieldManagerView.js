											...
											>
												...
												<div className="row-meta">
													...
													<div className="row-actions">
														{ /* O desenho põe as ações na linha, não dentro de um
														     menu: duplicar e excluir são o que se faz a um
														     campo depois de o ver. Editar não está aqui porque
														     a área de edição é o painel ao lado, e a linha já
														     a abre. */ }
														<div className="row-quick">
															...
															isProtected(
																...
																<button
																	type="button"
																	className="icon-btn small-icon danger"
																	aria-label={ sprintf(
																		/* translators: %s: field label. */
																		__(
																			'Excluir %s',
